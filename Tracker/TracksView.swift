...
final class TracksView: UIViewController, UISearchBarDelegate {
    ...
    private func setupTabBar() {
        ...
        // Добавляем таббар как дочернюю view
    ...
    private func addPlusButton() {
        ...
        plusButton.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 20).isActive = true
